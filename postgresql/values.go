...
type ValuesBackupCronjob struct {
	...
	Resources ValuesBackupCronjobResources `json:"resources,omitempty" yaml:"resources,omitempty" mapstructure:"resources,omitempty"`
	...
	// backup.cronjob.resources is set (backup.cronjob.resources is recommended for
	// production).
...
// Set container requests and limits for different resources like CPU or memory
type ValuesBackupCronjobResources map[string]interface{}
