...
type Values struct {
	...
	// Kubectl corresponds to the JSON schema field "kubectl".
	Kubectl *ValuesKubectl `json:"kubectl,omitempty" yaml:"kubectl,omitempty" mapstructure:"kubectl,omitempty"`
...
type ValuesKubectl struct {
	// kubectl command to execute
	Command []string `json:"command,omitempty" yaml:"command,omitempty" mapstructure:"command,omitempty"`

	// Image corresponds to the JSON schema field "image".
	Image *ValuesKubectlImage `json:"image,omitempty" yaml:"image,omitempty" mapstructure:"image,omitempty"`

	// Resources corresponds to the JSON schema field "resources".
	Resources *ValuesKubectlResources `json:"resources,omitempty" yaml:"resources,omitempty" mapstructure:"resources,omitempty"`
}

type ValuesKubectlImage struct {
...
type ValuesKubectlResources struct {
	// The resources limits for the kubectl containers
	Limits ValuesKubectlResourcesLimits `json:"limits,omitempty" yaml:"limits,omitempty" mapstructure:"limits,omitempty"`

	// The requested resources for the kubectl containers
	Requests ValuesKubectlResourcesRequests `json:"requests,omitempty" yaml:"requests,omitempty" mapstructure:"requests,omitempty"`
}

// The resources limits for the kubectl containers
type ValuesKubectlResourcesLimits map[string]interface{}

// The requested resources for the kubectl containers
type ValuesKubectlResourcesRequests map[string]interface{}
...
type ValuesSentinelService struct {
	...
	CreateMaster bool `json:"createMaster,omitempty" yaml:"createMaster,omitempty" mapstructure:"createMaster,omitempty"`
